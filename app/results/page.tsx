      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          <div className="card p-6 text-center">
            <div className="text-4xl font-bold text-primary-gold mb-2">500+</div>
            ...
            <div key={index} className="card p-6 hover:scale-[1.02] transition-transform duration-300">
              ...
              <div className="border-t pt-4 mt-4">
                <div className="flex items-start mb-3">
                  <svg className="w-5 h-5 text-primary-gold mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
