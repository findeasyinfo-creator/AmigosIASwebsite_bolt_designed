...
export const api = {
  ...
  blogPosts: {
    getAll: async (params?: any): Promise<ApiResponse<any>> => {
      const queryParams = params ? `?${new URLSearchParams(params).toString()}` : '';
      return apiFetch<any>(`/blog-posts${queryParams}`, {
        method: 'GET',
      });
    },
    ...
    getBySlug: async (slug: string): Promise<ApiResponse<any>> => {
      return apiFetch<any>(`/blog-posts/slug/${slug}`, {
        method: 'GET',
      });
    },

    getCategories: async (): Promise<ApiResponse<any>> => {
      return apiFetch<any>('/blog-posts/categories', {
        method: 'GET',
      });
    },
  ...
  resources: {
    getAll: async (params?: any): Promise<ApiResponse<any>> => {
      const queryParams = params ? `?${new URLSearchParams(params).toString()}` : '';
      return apiFetch<any>(`/resources${queryParams}`, {
        method: 'GET',
      });
    },
    ...
    getFilterOptions: async (): Promise<ApiResponse<any>> => {
      return apiFetch<any>('/resources/filter-options', {
        method: 'GET',
      });
    },
