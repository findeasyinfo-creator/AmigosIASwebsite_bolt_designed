...
function HeroContent() {
  ...
  const handleOpenDialog = (slide?: HeroSlide) => {
    if (slide) {
      ...
      setFormData({
        ...
        ctaEnabled: slide.ctaEnabled ?? true,
  ...
  const columns: ColumnDef<HeroSlide>[] = [
    ...
    },
    {
      ...
      header: 'CTA Button',
      cell: ({ row }) => {
        const ctaLabel = row.original.ctaLabel;
        const ctaEnabled = row.original.ctaEnabled;
        if (!ctaEnabled) {
    ...
    <div>
      ...
      <Dialog open={openDialog} onOpenChange={handleCloseDialog}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader className="bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-600 text-white p-6 rounded-t-lg -mt-6 -mx-6 mb-4">
            ...
            <TabsContent value="content" className="space-y-4">
                ...
                <div className="flex items-center space-x-2 mb-4">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setFormData({ ...formData, ctaEnabled: checked })
                    }
                  />
                  <Label htmlFor="ctaEnabled">Show CTA Button</Label>
                </div>
              ...
              <Card className="p-4 bg-gray-50">
                ...
                <p className="text-sm text-gray-600 mb-3">
                  Add feature points that appear below the description
                </p>
