        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 mb-8">
            ...
            {(selectedSubject !== 'all' || selectedPaper !== 'all' || selectedDate !== 'all') && (
              <button
                ...
                className="mt-4 text-sm text-orange-500 hover:text-orange-600 hover:underline"
              >
                Clear All Filters
              </button>
            )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {filteredArticles.map((article) => (
              <div key={article.id} className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4 line-clamp-2">{article.summary}</p>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex flex-wrap gap-2">
                    {article.topics.map((topic, index) => (
                      <span
                        key={index}
                        className="px-2 py-1 bg-gradient-to-br from-amber-100 to-orange-100 text-gray-800 rounded text-xs shadow-sm"
                      >
                        {topic}
                      </span>
                    ))}
