...
export default function Demo() {
  ...
  // Setup auto-pause for each demo video
  const demo0 = useYouTubeAutoPause(
    playingCard === 0 ? demoVideos[0].videoId : null,
    'demo-video-0'
  );
  const demo1 = useYouTubeAutoPause(
    playingCard === 1 ? demoVideos[1].videoId : null,
    'demo-video-1'
  );
  const demo2 = useYouTubeAutoPause(
    playingCard === 2 ? demoVideos[2].videoId : null,
    'demo-video-2'
  );
